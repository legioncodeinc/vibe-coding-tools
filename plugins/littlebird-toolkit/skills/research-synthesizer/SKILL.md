...
description: "Synthesize a topic against Littlebird memory and current sources. Use for a concise what-changed research brief. Read README.md for the guide map."
