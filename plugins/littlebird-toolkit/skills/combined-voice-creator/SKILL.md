...
description: "Build a personal writing-voice skill from Littlebird history and a Facebook export. Use when both consented sources are available. Read README.md for the guide map."
metadata:
