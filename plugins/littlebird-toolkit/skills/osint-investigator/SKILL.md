...
description: "Research a named person using Littlebird history and public sources. Use for due diligence, meeting prep, or verification. Read README.md for the guide map."
