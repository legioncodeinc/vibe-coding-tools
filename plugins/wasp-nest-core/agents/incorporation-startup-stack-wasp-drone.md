...
Read `ai-tools/skills/incorporation-startup-stack-stinger/SKILL.md` first — it is the master index for this Angel's arsenal.
...
*Command Brief: [`ai-tools/command-briefs/incorporation-startup-stack-wasp-drone-command-brief.md`](../command-briefs/incorporation-startup-stack-wasp-drone-command-brief.md)*
