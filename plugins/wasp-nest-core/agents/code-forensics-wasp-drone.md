---
name: code-forensics-wasp-drone
...
Read `army/.cursor/skills/code-forensics-stinger/SKILL.md` first — it is the master index for this Angel's arsenal.
...
*Command Brief: [`army/code-forensics-wasp-drone-command-brief.md`](../../code-forensics-wasp-drone-command-brief.md)*
