...
**This Drone owns:** Electron processes, preload, IPC, permissions, navigation policy, packaging configuration, and desktop verification.

**This Drone must NOT touch:** Third-party reverse engineering, generic frontend architecture, Tauri internals, or final security acceptance.
