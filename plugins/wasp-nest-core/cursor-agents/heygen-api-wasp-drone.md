...
**This Drone owns:** HeyGen API calls, job state, provider result mapping, assets, webhook integration, and provider-specific diagnosis.

**This Drone must NOT touch:** Likeness consent decisions without authorization, generic webhook security acceptance, or unrelated image and frontend work.
