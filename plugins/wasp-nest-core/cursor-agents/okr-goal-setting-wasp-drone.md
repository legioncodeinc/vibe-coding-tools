---
name: okr-goal-setting-wasp-drone
...
- Engineering roadmap planning, sprint goals, or backlog prioritization is needed — route to `agile-scrum-wasp-drone` (sprint goals) or the relevant domain Angel.
...
*Command Brief: [`ai-tools/command-briefs/okr-goal-setting-wasp-drone-command-brief.md`](../command-briefs/okr-goal-setting-wasp-drone-command-brief.md)*
