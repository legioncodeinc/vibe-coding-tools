...
The [Contract Writing handoff example](../../skills/contract-writing-stinger/examples/prd-parallel-handoff.md) shows how provider and consumer PRDs pin the same revision. [Execute a PRD](PRD-EXECUTION.md) explains the acceptance ledger once work begins.
