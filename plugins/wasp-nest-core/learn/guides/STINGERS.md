...
This is progressive disclosure. A request about recovering a deleted branch should load the [Git Stinger](../../skills/git-stinger/SKILL.md) and its recovery guide, not every Git research file. A Stinger whose root file dumps all research into the initial context makes both routing and verification harder.
