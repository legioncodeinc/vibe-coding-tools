...
> TODO: open question, CSP nonce integration with `next-themes` inline script requires middleware-level nonce injection. Confirm with `security-wasp-drone` before implementing in production.
