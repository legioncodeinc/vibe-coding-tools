...
Grounding: `../references/worked-example.md` (a 160-file merge). Templates: `../templates/library-merge-map.md`, `../templates/merge-drone-prompt.md`. Tool: `../scripts/verify_kb.py`.
...
## Header and link rules the drones must follow
...
- The two drone reports (counts, hash checks, unplaced content, which should be none).
