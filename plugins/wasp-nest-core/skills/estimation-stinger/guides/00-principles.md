...
Core framing principles for `estimation-wasp-drone`. Read this guide before any other.
...
## This Drone's scope boundary

`estimation-wasp-drone` owns:
...
`estimation-wasp-drone` does NOT own:
...
- Roadmap PRD authorship: `library-wasp-drone`
