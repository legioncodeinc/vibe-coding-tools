...
- [ ] `db-wasp-drone`, {{schema, indexes, processed_webhook_events table}}
- [ ] `security-wasp-drone`, {{secret storage, PII handling, RBAC on portal sessions}}
- [ ] `react-wasp-drone`, {{Stripe.js, Elements, EmbeddedCheckout}}
- [ ] `library-wasp-drone`, {{PRD scoping for any new payments feature}}
- [ ] `quality-wasp-drone`, {{post-fix verification}}
