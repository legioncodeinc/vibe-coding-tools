...
The vibe-coder's AI coding tool advisor. This Stinger equips `ai-coding-tools-wasp-drone` to recommend, compare, configure, and debug AI coding tools across the 2026 ecosystem.
...
```
ai-coding-tools-stinger/
├── SKILL.md                          # Drone's primary instruction set
├── README.md                         # This file
