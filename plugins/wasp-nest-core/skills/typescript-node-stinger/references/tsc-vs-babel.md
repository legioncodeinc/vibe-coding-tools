...
> Demoted in favor of **tsc for types + esbuild for bundling** (see `guides/01-stack-enforcement.md`, `guides/04-esbuild-bundling.md`). Babel is not in the Wasp Nestmind pipeline.
