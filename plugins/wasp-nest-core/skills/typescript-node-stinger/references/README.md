...
2. **Recognition** - these tools show up everywhere in the broader TS/Node ecosystem. When you see them in another repo, these notes tell you what you're looking at and what the Wasp Nestmind equivalent is.
