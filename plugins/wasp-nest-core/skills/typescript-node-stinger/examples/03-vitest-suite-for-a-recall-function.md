...
Goal: a full Vitest suite for `readSummariesByIds` from `examples/02`. Shows the Wasp Nestmind testing pattern: async, inject a fake client, assert behavior and the guarded SQL, no real network.
