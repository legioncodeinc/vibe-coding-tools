...
These headers are HTTP-layer concerns for `http-rest-fundamentals-wasp-drone`. The enforcement and prioritization of OWASP-level violations is `security-wasp-drone`'s domain.
