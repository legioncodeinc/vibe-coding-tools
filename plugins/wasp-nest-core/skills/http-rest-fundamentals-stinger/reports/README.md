...
This folder accumulates audit findings reports produced by `http-rest-fundamentals-wasp-drone`.
...
- Handoffs to `security-wasp-drone` (OWASP-level header security) and `auth-wasp-drone` (auth-header semantics)
