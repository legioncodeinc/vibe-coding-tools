...
**Auditor:** http-rest-fundamentals-wasp-drone
**Date:** {YYYY-MM-DD}
...
- **Security findings:** {List any OWASP-level security header issues found here for security-wasp-drone follow-up}
- **Auth findings:** {List any auth-header semantics issues for auth-wasp-drone follow-up}
