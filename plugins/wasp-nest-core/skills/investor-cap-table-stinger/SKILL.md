...
description: "Manage startup cap tables and fundraising paperwork. Use for SAFEs, options, 409A, priced rounds, vesting, or data rooms. Read README.md for the guide map."
---
...
Procedural arsenal for `investor-cap-table-wasp-drone`. Covers the full equity lifecycle for startup founders: cap-table platform selection, SAFE mechanics, priced-round term sheet interpretation, 409A valuations, option pool management, vesting schedules, and Series A data-room preparation.
...
Load this stinger when `investor-cap-table-wasp-drone` is invoked. Primary triggers:
...
*Forged by `stinger-forge` from `ai-tools/command-briefs/investor-cap-table-wasp-drone-command-brief.md` and `research/`. Part of the Legion AI Tools Factory by [Mario Aldayuz a.k.a @thenotoriousllama](https://github.com/thenotoriousllama).*
