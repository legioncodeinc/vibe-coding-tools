...
The canonical architecture for bi-directional CRM sync. This is the most complex guide in the stinger because conflict resolution has no universally correct answer -- the wasp-drone's job is to make the policy explicit before any code is written.
