...
CRM connectivity playbook for `crm-integration-wasp-drone`. This Stinger encodes the decision framework and procedural guides for connecting a product to HubSpot, Salesforce, Pipedrive, Attio, Folk, Close, or Copper.
...
Research synthesized from 10 source notes, November 2025 -- May 2026. Key findings in `research/research-summary.md`. Command Brief at `../../command-briefs/crm-integration-wasp-drone-command-brief.md`.
