...
- **payments-wasp-drone:** Stripe Express / payout integration required: YES / NO
- **security-wasp-drone:** Platform API key management review required: YES / NO
- **db-wasp-drone:** Custom attribution table schema required: YES / NO
- **cold-outreach-wasp-drone:** Outbound affiliate recruitment campaign planned: YES / NO
