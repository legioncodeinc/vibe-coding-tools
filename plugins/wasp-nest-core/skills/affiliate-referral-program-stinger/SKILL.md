...
description: "Design SaaS affiliate and referral programs. Use for platform choice, attribution, commissions, fraud, or program economics. Read README.md for the guide map."
---

# Affiliate and Referral Program Stinger

Practitioner arsenal for `affiliate-referral-program-wasp-drone`. Encodes the domain knowledge to select, configure, instrument, and economically validate affiliate and referral programs for SaaS products in 2026.
