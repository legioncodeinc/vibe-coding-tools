...
- **ux-ui-svelte-wasp-drone** owns whether the page's visual composition matches the brief. You catalog; they review.
- **security-wasp-drone** reviews `authRequirement` for every page that exposes sensitive data.
- **library-wasp-drone** cross-links the page to its owning feature PRD.
