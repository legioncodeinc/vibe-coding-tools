...
## What ux-ui-svelte-wasp-drone filled vs what the generator filled
...
| `tenantOverridable` | ux-ui-svelte-wasp-drone (defaults to true; opt-out only) |
| `semanticRole` | **ux-ui-svelte-wasp-drone** (human meaning, you never write this) |
| `uxuiBriefRef` | ux-ui-svelte-wasp-drone |
...
- [x] `semanticRole` authored by ux-ui-svelte-wasp-drone
