...
**Recommended schema (route to `db-wasp-drone` for full schema design):**
...
Instrument these events for every checklist (route to analytics Drone for implementation):
