...
Run this checklist before declaring tool/API/CLI documentation complete, for any project this Drone documents. All 10 items must pass or be explicitly acknowledged.
