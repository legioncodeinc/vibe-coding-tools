...
**Date:** {{YYYY-MM-DD}}
**Reviewer:** ci-release-wasp-drone
...
- [ ] `security-wasp-drone` - {{if any secret reachable past pack-check / supply-chain concern surfaced}}
- [ ] `dependency-audit-wasp-drone` - {{if a lockfile / CVE concern surfaced}}
- [ ] `harness-integration-wasp-drone` - {{if a bundle's export semantics are in question}}
- [ ] `changelog-release-notes-wasp-drone` - {{if release-notes prose is needed}}
