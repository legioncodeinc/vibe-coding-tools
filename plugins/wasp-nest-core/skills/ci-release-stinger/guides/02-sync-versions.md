...
> **npm package publishing case (legacy, secondary).** Applies when the artifact IS a published npm package (the Wasp Nestmind case). For the SvelteKit-on-Vercel primary case, see `guides/00-principles.md` and guides 09-16.
