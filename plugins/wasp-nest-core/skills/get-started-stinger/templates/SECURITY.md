...
GitHub checks those three locations in that order. If you name GitHub Private
Vulnerability Reporting below as the primary channel, enable that feature on
the repository (Security tab > Reporting > Privately report a vulnerability)
before publishing this file, or the instructions will be wrong the moment
someone needs them.
-->
...
| Version | Supported |
| --- | --- |
| {latest_major}.x | :white_check_mark: |
| {previous_major}.x | {:white_check_mark: or :x:} |
| < {oldest_supported_major}.0 | :x: |

## Reporting a Vulnerability

Please do not report security vulnerabilities through public GitHub issues, discussions, or pull requests.

Instead, report vulnerabilities through [GitHub private vulnerability reporting]({repo_url}/security/advisories/new) for this repository.

If private vulnerability reporting is unavailable or unusable for your report, email the maintainers at {security_email}.
