...
ai_description: |
  ...
  Shared contract records MUST live in contracts/CTR-<###>-<kebab-slug>.md.
...
human_description: |
  ...
  - contracts/: Accepted shared boundaries for parallel PRDs
...
| `contracts/` | `CTR-<###>-<slug>.md` records for shared API, event, data, permission, or state agreements. |
