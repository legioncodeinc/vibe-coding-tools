...
> Companion agent: [`.claude/agents/ux-ui-svelte-wasp-drone.md`](../../../.claude/agents/ux-ui-svelte-wasp-drone.md)

## What lives here

This folder is the **single source of truth** for every visual and interaction
decision in the {{product}} app. Created by `design-system-wasp-drone` on
...
(b) be rejected by `quality-wasp-drone` with a pointer back here.
