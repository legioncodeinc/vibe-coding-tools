...
**Companion Drone:** `ux-ui-svelte-wasp-drone`
...
- Estimated refactor duration (handled by `ux-ui-svelte-wasp-drone`): {{weeks}}
}}

## Open questions handed to ux-ui-svelte-wasp-drone

- {{any loose ends for the companion Drone}}
...
- [ ] `ux-ui-svelte-wasp-drone` ownership confirmed in `README.md`.
- [ ] Companion Drone stub authored (if not already present) at
      `.claude/agents/ux-ui-svelte-wasp-drone.md`.
