...
This folder accumulates past README audit summaries produced by `readme-writing-wasp-drone`.
...
The folder is initially empty. Reports accumulate over time as `readme-writing-wasp-drone` processes README audits.
