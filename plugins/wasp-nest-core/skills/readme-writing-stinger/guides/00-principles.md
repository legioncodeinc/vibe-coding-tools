...
Extraction threshold: 2,000 words, flag for docs-site extraction route to `library-wasp-drone`.
...
| Condition | Action |
|---|---|
| README exceeds 2,000 words | Flag extraction; hand off to `library-wasp-drone` |
| User wants a full docs site | Hand off to `library-wasp-drone` |
| CI badge pipeline needs setup | Hand off to `ci-release-wasp-drone` |
| TypeScript/Node package publishing flow needs documenting | Hand off to `typescript-node-wasp-drone` |
