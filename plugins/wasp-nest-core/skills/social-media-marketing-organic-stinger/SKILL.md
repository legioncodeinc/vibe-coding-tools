...
description: "Plan authentic organic social growth. Use for platform focus, founder voice, build-in-public, calendars, or AI-slop avoidance. Read README.md for the guide map."
---

# Social Media Marketing Organic Stinger

Equips `social-media-marketing-organic-wasp-drone` to deliver authentic, platform-native, founder-led social media strategy.
...
|---|---|
| Email newsletter setup and growth | `newsletter-platform-wasp-drone` |
| Search-driven content strategy (blog posts, landing pages) | `seo-aeo-wasp-drone` |
...
| Brand/visual design for social assets | `design-system-wasp-drone` or `ux-ui-wasp-drone` |
| Teams > 10 people or dedicated social media roles | Out of scope — flag and recommend agency tooling |

---

*Forged by `stinger-forge` from `social-media-marketing-organic-wasp-drone-command-brief.md` and `research/`. Part of the Legion AI Tools Factory.*
