/**
 * ColumnDef Table Spec - vector-store-stinger template
 *
 ...
 *
 * Source: guides/deeplake-01-schema-design.md, guides/deeplake-07-no-orm-columndef.md.
 */
...
/**
 * Indexing (see guides/deeplake-02-indexing.md):
 *
...
/**
 * SQL guards (see guides/deeplake-05-querying-deeplakeapi.md):
 *
 ...
 *
 * PII flags: note PII columns in the schema spec so `security-wasp-drone` can audit
 * creds / creds_key / retention. vector-store-wasp-drone flags PII; security-wasp-drone audits.
 */
