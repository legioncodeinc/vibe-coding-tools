...
4. Verification query (handed to `quality-wasp-drone`) confirms the column exists and back-filled rows carry the default.
...
- [ ] Specify verification queries (handed to `quality-wasp-drone`).
