...
description: "Investigate software vendor engagements using invoices, messages, git, and delivery evidence. Use for fee-clawback or breach evidence. Read README.md for the guide map."
---
