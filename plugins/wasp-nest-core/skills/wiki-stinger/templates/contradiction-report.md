...
[Append each contradiction below as wiki-wasp-drone detects it during the day. One file per day. Increment `contradiction_count` in frontmatter on each append.]
...
- wiki-wasp-drone creates from this template on the day's first contradiction; appends thereafter.
