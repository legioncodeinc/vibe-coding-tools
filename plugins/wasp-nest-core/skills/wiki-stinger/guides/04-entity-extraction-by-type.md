...
**Gotchas:**
- The longer-form module narrative is library-wasp-drone's job under `library/knowledge/private/<domain>/`. wiki-wasp-drone's `module` entity is a stub-style index pointing at the per-callable entities inside the file.
