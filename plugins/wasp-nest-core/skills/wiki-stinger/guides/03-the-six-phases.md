...
For all non-lint invocations (`document` / `update` / `scan-directory`), wiki-wasp-drone runs the same six phases in order. Lint mode follows [`guides/09-lint-mode.md`](09-lint-mode.md) instead.
