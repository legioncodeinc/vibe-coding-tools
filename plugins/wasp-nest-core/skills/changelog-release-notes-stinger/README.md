...
Paired with `changelog-release-notes-wasp-drone`, the specialist that turns merged PRs into a Keep-a-Changelog entry, picks the right semver bump, and drafts the GitHub Release.
...
- **Copy craft** - impact-first release notes, the Wasp Nestmind verb table, the honest scope note, the before/after test.
