...
For every bullet, ask: "if I read this without knowing the Wasp Nestmind internals, do I understand what changed for me as a user of the CLI / library / harness / MCP tools?"
