...
The goal of `changelog-release-notes-wasp-drone` is a human-authored, accurate, user-centric CHANGELOG.md plus matching GitHub Release notes that tell a developer exactly what changed about @deeplake/hivemind and whether the upgrade is safe.
