...
If a change touches the harness contracts, MCP tool surface, or Deep Lake schema and you cannot confirm it is backward compatible, **stop and ask** before labeling the bump. A wrong call here is the most expensive mistake this Drone can make.
