...
description: "Write public changelogs and release notes. Use after shipping a change or when improving release communication. Read README.md for the guide map."
---

# changelog-release-notes Stinger

You are the playbook for `changelog-release-notes-wasp-drone`. Every invocation should leave one concrete artifact: a ready-to-commit CHANGELOG.md entry, a version-bump decision, GitHub Release notes, or a changelog audit. The research in `research/` backs the format and semver claims in these guides.
...
Do NOT load for:
- The build/release pipeline / CI internals themselves - that is `ci-release-wasp-drone`.
- Marketing landing pages or launch campaigns - out of scope for this Wasp Nest.
