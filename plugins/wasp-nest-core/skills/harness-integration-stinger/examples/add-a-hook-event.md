...
*Part of the Wasp Nestmind six-host case study - see `examples/case-study-hivemind-six-host-installer.md` for the full context. This worked example predates and is not superseded by that file.*
