...
**Drone:** csv-xlsx-import-export-wasp-drone
**Date:** {YYYY-MM-DD}
...
| Item | Owner | Status |
|---|---|---|
| Upload endpoint security review | security-wasp-drone | {pending / done} |
| Database bulk-insert performance | db-wasp-drone | {pending / done / n/a} |
| File drop-zone UI review | ux-ui-svelte-wasp-drone | {pending / done / n/a} |
