...
## React side (sketch, full React work hands off to react-wasp-drone)
...
- **Auth provider choice (Clerk / WorkOS / Auth0 / Supabase Auth)**: `auth-wasp-drone`.
- **React component / state / data-fetching shape**: `react-wasp-drone`.
- **Security audit (XSS surface, RBAC correctness, threat model)**: `security-wasp-drone`.
