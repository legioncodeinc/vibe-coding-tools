...
- when to escalate to `design-system-wasp-drone` for a system-level response.
...
## When this escalates beyond ux-ui-wasp-drone

Hand off to `design-system-wasp-drone` per `guides/09-system-level-escalation.md` if any of the following:
