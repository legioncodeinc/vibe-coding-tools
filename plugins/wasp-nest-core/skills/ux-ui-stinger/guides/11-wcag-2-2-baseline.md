...
If a project explicitly chases AAA (e.g., government client), the Angel surfaces a handoff to `design-system-wasp-drone` per `guides/09-system-level-escalation.md`.
