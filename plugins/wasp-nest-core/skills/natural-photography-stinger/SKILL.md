...
description: "Generate or retouch photos of consented models. Use for realistic capture prompts, source-image gating, or honest EXIF metadata. Read README.md for the guide map."
license: AGPL-3.0-or-later
metadata:
  version: 1.1.0
  domain: photography
  pairs_with: natural-photography-wasp-drone
