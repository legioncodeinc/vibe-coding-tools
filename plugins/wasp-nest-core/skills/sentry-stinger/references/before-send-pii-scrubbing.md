...
Escalate any policy question about what counts as sensitive for this specific app (beyond the generic PII categories above) to `security-wasp-drone` rather than deciding unilaterally in this scrubbing function.
