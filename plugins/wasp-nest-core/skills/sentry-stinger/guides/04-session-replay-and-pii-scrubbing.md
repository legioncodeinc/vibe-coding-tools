...
Any policy question about what counts as sensitive for this specific app, beyond the generic PII categories covered here, belongs to `security-wasp-drone` - see `guides/05-alerting-without-noise.md`'s escalation note and the skill's Critical Directive sibling links.
