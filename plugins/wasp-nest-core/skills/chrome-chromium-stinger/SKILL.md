...
metadata:
  hive-drone: chrome-chromium-wasp-drone
  domain: chrome-chromium
  pair-drone: chrome-chromium-wasp-drone
...
- [chrome-chromium-wasp-drone](../../agents/chrome-chromium-wasp-drone.md) - paired implementation specialist.
