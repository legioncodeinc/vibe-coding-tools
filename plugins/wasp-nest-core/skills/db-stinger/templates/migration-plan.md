...
- **`quality-wasp-drone`**: runs verification queries above; confirms green.
- **`security-wasp-drone`**: review any new PII columns or RLS impact.
- **`react-wasp-drone`**: flag any data-layer changes the UI must adopt.
