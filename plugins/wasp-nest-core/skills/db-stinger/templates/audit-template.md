...
- [ ] `react-wasp-drone`: {{if any N+1 risks at the data-layer edge}}
- [ ] `security-wasp-drone`: {{if any PII / RLS / encryption-at-rest findings}}
- [ ] `mind-wasp-drone`: {{if any pgvector / embedding-storage decisions}}
- [ ] `quality-wasp-drone`: {{post-migration verification queries}}
