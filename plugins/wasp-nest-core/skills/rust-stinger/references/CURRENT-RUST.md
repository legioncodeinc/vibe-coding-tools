...
8. Pass dependency findings to `dependency-audit-wasp-drone`, security implications to `security-wasp-drone`, CI topology to `ci-release-wasp-drone`, and final plan conformance to `quality-wasp-drone`.
