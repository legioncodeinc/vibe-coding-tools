...
description: "Coach Scrum teams. Use for ceremonies, roles, Definition of Done, estimation, or Scrum anti-patterns. Read guides/ for the decision path."
...
6. **Hand off CI/deployment gate implementation to `devops-wasp-drone`.** The DoD may reference CI gates; the stinger does not implement them.
