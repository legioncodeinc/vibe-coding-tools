...
- [ ] `security-wasp-drone` invoked if the change touches auth, payments, or PII
...
## Escalation items for `devops-wasp-drone`

The following DoD items require `devops-wasp-drone` for implementation:
