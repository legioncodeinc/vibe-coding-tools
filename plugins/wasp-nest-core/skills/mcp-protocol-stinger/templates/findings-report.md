...
**Auditor:** mcp-protocol-wasp-drone
**Date:** {YYYY-MM-DD}
...
- **Auth / credential findings:** {Token lifecycle, credential storage -> security-wasp-drone}
- **Security findings:** {SQL injection in handlers, OWASP-level issues -> security-wasp-drone}
- **Deeplake findings:** {Query semantics, schema, vector search -> vector-store-wasp-drone}
