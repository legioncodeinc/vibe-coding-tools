...
This folder accumulates MCP server / tool audit findings produced by `mcp-protocol-wasp-drone`.
...
- Handoffs to `security-wasp-drone` (credentials/OAuth, injection/OWASP), and `vector-store-wasp-drone` (query/schema)
