...
This folder collects past Lighthouse audit reports produced by `lighthouse-pagespeed-wasp-drone`.
...
This report was produced for: <PR author / feature team / devops-wasp-drone / etc.>
```
