...
Load this skill when `lighthouse-pagespeed-wasp-drone` is invoked. Trigger phrases:
...
Do NOT load for:
- SEO content strategy, keyword research, or metadata optimization (route to `seo-aeo-wasp-drone`)
- Core Web Vitals implementation fixes like image optimization or JS bundle reduction (route to `react-wasp-drone` or `performance-optimizer`)
- Accessibility design decisions beyond Lighthouse-flagged technical issues
- CI/CD pipeline topology beyond the Lighthouse-specific configuration step (route to `devops-wasp-drone`)
...
*Command Brief: `ai-tools/command-briefs/lighthouse-pagespeed-wasp-drone-command-brief.md`*
*Research: `research/research-summary.md` (normal depth, 9 sources, May 2026)*
*Forged by `stinger-forge` as part of The Wasp Nest by [Mario Aldayuz a.k.a @thenotoriousllama](https://github.com/thenotoriousllama)*
