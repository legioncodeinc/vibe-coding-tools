...
Fill at the end of an implementation invocation. Hand to `security-wasp-drone` for verification.

**Project:** _____
**Auth provider:** _____
**Date:** _____
**Reporter:** auth-wasp-drone

---

## Summary

One paragraph: what was built, what provider was chosen, what scopes are in play, what's flagged for security-wasp-drone.
...
## Items explicitly handed to security-wasp-drone
...
## Items handed to other Drones

| Drone | What | Why |
|---|---|---|
| `db-wasp-drone` | Schema migration + RLS policies | auth-wasp-drone flagged the requirements |
| `react-wasp-drone` | `<SignIn />`, `<UserMenu />` JSX | Protocol vs UI split |
| `quality-wasp-drone` | Post-implementation QA | After security audit |
