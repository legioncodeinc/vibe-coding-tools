...
8. **Never fork or modify the engine.** Call the installed system; follow the drone-army-update contract (no upstream script execution during install, preserve ownership manifest, no silent overwrites). (research/11)
