...
1. **Token-first:** Every size, weight, and family reference in component code must route through a CSS custom property. Raw values create drift the wasp-drone cannot audit.
