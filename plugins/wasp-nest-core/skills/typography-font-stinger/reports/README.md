...
This folder accumulates audit and session reports produced by `typography-font-wasp-drone`.
...
7. **Handoff notes** - what `ux-ui-svelte-wasp-drone` and `devops-wasp-drone` need to know

---

*Reports are written inline by the wasp-drone and optionally persisted here when the user says "save the report" or "persist the audit".*
