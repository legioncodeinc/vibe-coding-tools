...
{If this reference material is grounded in external documentation, cite it here the same way the Wasp Nest research files do: a bracketed pointer to the source, so a future author can verify or update the claim.}
