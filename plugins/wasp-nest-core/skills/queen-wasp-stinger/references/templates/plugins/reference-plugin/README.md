...
This is a minimal, working cross-harness plugin skeleton for Project Wasp Nest. Every file in here is a stub, not a finished plugin. Copy this folder, rename it, and replace the `{placeholder}` values before you ship anything.
