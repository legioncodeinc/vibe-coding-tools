<!--
This is a Wasp Nest command template. It is a flat markdown file, not a folder,
...
1. Load the pest-controller-suit skill and consult its roster before making any routing decision. This is the first instruction, always, no exceptions. Every Wasp Nest command starts here because the roster is what tells you which drone and stinger this command actually needs, and routing around it produces work that doesn't match the Wasp Nest's conventions.
...
<!--
The Ship Gate block below applies because Wasp Nest commands are dev-focused by
