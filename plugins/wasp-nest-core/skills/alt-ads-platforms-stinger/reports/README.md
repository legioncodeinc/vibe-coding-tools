...
This folder accumulates channel audit and campaign performance reports produced by `alt-ads-platforms-wasp-drone`.
...
This folder starts empty. Reports accumulate as `alt-ads-platforms-wasp-drone` completes engagements.
