...
description: "Plan paid acquisition beyond Meta and Google Search. Use for LinkedIn, TikTok, Reddit, Bing, Pinterest, Quora, YouTube, or podcasts. Read README.md for the guide map."
---

# alt-ads-platforms Stinger

Arsenal for `alt-ads-platforms-wasp-drone` — the Legion Army's specialist for paid acquisition across the 10 alternative platforms: LinkedIn, TikTok, Reddit, Microsoft/Bing, X/Twitter, Pinterest, Quora, YouTube (standalone), Spotify Ad Studio, and the podcast advertising ecosystem.
