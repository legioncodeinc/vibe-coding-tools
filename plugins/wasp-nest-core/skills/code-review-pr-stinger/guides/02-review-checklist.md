...
**Security (surface to security-wasp-drone if found):**
...
When the Drone generates a checklist for a specific PR, it should scope the checklist to the file types and concerns visible in the diff:
