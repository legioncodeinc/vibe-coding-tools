...
**Trunk-based checklist for the Drone:**
...
## How the Drone flags a large PR

When a PR exceeds a threshold, the Drone's output is:
...
The Drone never blocks the PR based on size alone. It flags the risk and proposes splits. The human decides.
