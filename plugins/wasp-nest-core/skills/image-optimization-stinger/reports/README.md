...
This folder collects past optimization audit reports produced by `image-optimization-wasp-drone`.
...
Initially empty. Reports accumulate over time as `image-optimization-wasp-drone` is invoked on projects.
