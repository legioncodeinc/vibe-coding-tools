...
> **Instructions for `branching-strategy-wasp-drone`:** Replace every `[PLACEHOLDER]` with team-specific values. Delete sections that do not apply. Commit this document to `docs/engineering/branching-policy.md` (or equivalent). Route branch-protection ruleset changes to `github-repo-health-wasp-drone`.
...
> Route all ruleset configuration to `github-repo-health-wasp-drone`.
...
*Policy authored by `branching-strategy-wasp-drone`. Last forged: [YYYY-MM-DD].*
