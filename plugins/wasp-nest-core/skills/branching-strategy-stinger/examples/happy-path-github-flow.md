...
## Branch protection (configure in GitHub - route to github-repo-health-wasp-drone)
- Require PR review: 1
...
This example demonstrates the ~80% case. The key insight the Drone delivers that the team didn't ask for is the feature-flag explana