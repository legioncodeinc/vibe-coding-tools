...
**Built by:** website-wasp-drone (Cursor IDE Drone)
...
- `seo-aeo-wasp-drone` (SvelteKit track): post-build SEO audit and schema validation
- `security-wasp-drone`: CSP header tightening review
- `db-wasp-drone`: schema indexing and query audit
