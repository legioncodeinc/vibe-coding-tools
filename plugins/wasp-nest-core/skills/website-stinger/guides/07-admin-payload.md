...
For full Payload implementation details, invoke `website-wasp-drone` (Payload is owned by website-stinger; no separate Payload Drone exists) (or read `website-stinger/SKILL.md`).
