...
- [ ] Repo path and recommended downstream Drones listed

---

## Downstream Drone recommendations

At the end of the Build Report, recommend:

- `seo-aeo-wasp-drone` (SvelteKit track): post-build SEO audit
- `security-wasp-drone`: CSP header tightening
- `db-wasp-drone`: schema indexing review
- `quality-wasp-drone`: implementation-vs-PRD verification
