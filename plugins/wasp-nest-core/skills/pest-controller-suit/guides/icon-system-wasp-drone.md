...
## Do NOT route when
- The question is about icon size or color design tokens rather than the component itself; that belongs to ux-ui-svelte-wasp-drone.
- The question is about SVG sprite build-pipeline tooling (SVGO, svg-sprite CLI, vite-plugin-svgr) at the bundler level; that belongs to devops-wasp-drone.
- The question is general React bundle optimization beyond icon imports; that belongs to devops-wasp-drone.
...
- ux-ui-svelte-wasp-drone: supplies the size/color tokens the icon component consumes.
- devops-wasp-drone: owns the SVGO/sprite build pipeline and broader bundle optimization.
