...
## Do NOT route when
- The ask is which platform should host the docs: route to docs-site-wasp-drone.
- The ask is knowledge-base folder structure or organization: route to library-wasp-drone.
- The ask is OpenAPI spec authorship or enrichment: route to api-docs-wasp-drone.
- The ask is a README-specific review: route to readme-writing-wasp-drone.
- The ask is SEO metadata for the doc: route to seo-aeo-wasp-drone.

## Inputs the Drone needs
- The document (or PR diff) to review, or a completed ghostwrite intake brief for drafting mode.
- Any house style guide that should override the Drone's own voice/tone defaults.
...
- docs-site-wasp-drone: once content is drafted, for platform publishing.
- library-wasp-drone: for where the finished doc should live in the knowledge base.
- api-docs-wasp-drone: when a reviewed document references or embeds an OpenAPI spec.
