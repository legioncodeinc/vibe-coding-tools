...
> TODO: open question -- no published industry benchmark for take-home stipend rates as of 2026 research. The formula above is practitioner judgment. Flag to hiring-ats-wasp-drone that this guidance should be updated when a benchmark source is available.
