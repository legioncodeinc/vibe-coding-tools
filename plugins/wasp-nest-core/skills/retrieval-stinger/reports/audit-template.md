...
> Anything handed off: schema -> vector-store-wasp-drone; daemon -> embeddings-runtime-wasp-drone; PII/scope-as-security -> security-wasp-drone. Close-out order: security-wasp-drone then quality-wasp-drone.
...
> security-wasp-drone reviewed: yes/no. quality-wasp-drone reviewed: yes/no.
