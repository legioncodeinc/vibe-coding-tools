...
A per-query and aggregate table, before vs after, with the posture stamped on it. This is the audit evidence handed to quality-wasp-drone when a recall change ships. "Feels better" is not an entry in the table.
