...
Reference for the model recall depends on. retrieval-wasp-drone does not own the daemon (embeddings-runtime-wasp-drone does) - this note documents only the facts recall must hold true.
...
All of the above belong to embeddings-runtime-wasp-drone. retrieval-wasp-drone states the dimension and the null contract, and hands the rest over.
