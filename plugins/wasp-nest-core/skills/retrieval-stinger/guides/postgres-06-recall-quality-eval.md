...
2. Embedding model / dimension - handed jointly with embeddings-runtime-wasp-drone.
...
7. **Handed to quality-wasp-drone** as audit evidence when a retrieval change ships, same close-out convention this Stinger has always used for the Deep Lake pipeline.
