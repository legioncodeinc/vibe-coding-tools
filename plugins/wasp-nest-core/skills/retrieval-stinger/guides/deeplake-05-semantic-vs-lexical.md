...
- Embeddings off entirely -> only lexical is available, period. Recommending semantic is recommending a feature flip, which is embeddings-runtime-wasp-drone's call and a real 600MB + CPU cost.
