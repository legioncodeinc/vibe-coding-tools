---
name: review-funnels-stinger
license: AGPL-3.0-or-later
description: "Build SaaS review collection. Use for G2, Capterra, Trustpilot, Product Hunt, request timing, incentives, or negative reviews. Read README.md for the guide map."
---

# review-funnels-stinger

The procedural arsenal for `review-funnels-wasp-drone`. This Stinger encodes the full review-collection and reputation-management lifecycle for SaaS products, grounded in 2026 platform policies and practitioner-level research.

**Paired Angel:** `ai-tools/agents/review-funnels-wasp-drone.md`
**Command Brief:** `ai-tools/command-briefs/review-funnels-wasp-drone-command-brief.md`
**Research:** `ai-tools/skills/review-funnels-stinger/research/` (populated 2026-05-20 by scripture-historian)
...
*Forged by stinger-forge from `review-funnels-wasp-drone-command-brief.md` and scripture-historian research (2026-05-20). Part of the Legion AI Tools Factory by [Mario Aldayuz a.k.a @thenotoriousllama](https://github.com/thenotoriousllama).*
