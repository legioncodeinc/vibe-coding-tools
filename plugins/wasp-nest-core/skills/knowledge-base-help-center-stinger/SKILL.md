...
description: "Select and improve customer help centers. Use for KB platforms, search, AI deflection, localization, versioning, or content gaps. Read README.md for the guide map."
---

# knowledge-base-help-center Stinger

Opinionated playbook for `knowledge-base-help-center-wasp-drone`. Equips the Angel to select, set up, architect, and continuously improve customer-facing self-service knowledge bases in 2026.
...
3. Read `guides/02-ai-deflection.md` — the three AI deflection patterns and the hand-off protocol to `mind-wasp-drone`.
...
│   ├── 02-ai-deflection.md                  (3-pattern taxonomy; llms.txt; mind-wasp-drone hand-off)
...
- **Route embedding/RAG pipeline implementation to `mind-wasp-drone`.** The three deflection patterns specify the architecture boundary; `mind-wasp-drone` implements the vector retrieval side. Do not cross that boundary. See `guides/02-ai-deflection.md`.
