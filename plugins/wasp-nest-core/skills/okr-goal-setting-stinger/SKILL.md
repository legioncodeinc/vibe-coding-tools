...
description: "Write and audit OKRs. Use for measurable key results, quarterly cadence, grading, or OKR-vs-KPI decisions. Read README.md for the guide map."
---
...
Invoke `okr-goal-setting-wasp-drone` when the user needs to:
...
- Engineering roadmap or sprint planning (`agile-scrum-wasp-drone` owns Scrum; domain Angels own implementation)
...
*Forged by `stinger-forge` from `okr-goal-setting-wasp-drone-command-brief.md` and `research/`. Part of the Legion AI Tools Factory by [Mario Aldayuz a.k.a @thenotoriousllama](https://github.com/thenotoriousllama).*
