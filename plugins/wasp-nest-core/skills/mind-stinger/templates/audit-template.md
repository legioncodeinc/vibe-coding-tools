...
- **`db-wasp-drone`**: {{specific items, file:line + reason}}
- **`react-wasp-drone`**: {{specific items}}
- **`security-wasp-drone`**: {{prompt-injection / key-handling / PII items}}
- **`library-wasp-drone`**: {{PRD-shaped items}}
- **`quality-wasp-drone`**: {{eval-suite-as-evidence items}}
- **`asset-wasp-drone`**: {{coach-registry items}}
...
*Authored by mind-wasp-drone. Audit shape canonicalized in `.claude/skills/mind-stinger/templates/audit-template.md`.*
