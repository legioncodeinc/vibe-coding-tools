...
Core philosophy that governs how `discovery-research-wasp-drone` operates. Read this before any domain guide.
...
| Owner | `discovery-research-wasp-drone` | Domain implementation Angels |
...
- **Do not write a PRD until the winning opportunity and solution are validated.** The handoff to `library-wasp-drone` happens at validated-solution, not at "the team has a hypothesis."
...
|---|---|
| Pre-build discovery: what to build | Shipped-feature usability testing (`quality-wasp-drone`) |
| OST construction and maintenance | PRD authorship (`library-wasp-drone`) |
| JTBD interview scripts | Visual/design decisions (`ux-ui-wasp-drone`) |
