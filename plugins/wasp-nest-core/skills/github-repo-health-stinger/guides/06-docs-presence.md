...
Do not audit README *content quality* (that is `readme-writing-wasp-drone`'s job). This guide audits presence and completeness at a structural level.
...
README structural improvement (quickstart, badges, voice, conversion) → `readme-writing-wasp-drone`.
