...
- [ ] `ux-ui-svelte-wasp-drone`: {{if any visual / token findings}}
- [ ] `seo-aeo-wasp-drone`: {{if any Next.js SEO findings}}
- [ ] `security-wasp-drone`: {{if any auth / Server Action / storage findings}}
- [ ] `library-wasp-drone`: {{if refactor big enough to warrant a PRD}}
