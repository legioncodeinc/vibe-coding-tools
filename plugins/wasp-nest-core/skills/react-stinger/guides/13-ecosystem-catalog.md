...
The Wasp Nest may want a dedicated **TanStack ecosystem Drone** later (Query + Router + Table + Form + Start). Flagged in `research/research-plan.md` for a future brief.
