...
Paired with `cold-outreach-wasp-drone` (`ai-tools/agents/cold-outreach-wasp-drone.md`). Command Brief at `ai-tools/command-briefs/cold-outreach-wasp-drone-command-brief.md`. Research grounding from `scripture-historian` at `research/research-summary.md`.
