...
- If they threaten legal action regarding GDPR or CAN-SPAM: escalate to `security-wasp-drone` with the specific complaint details
...
Route CRM schema design to `db-wasp-drone` if the user needs a formal data model.
