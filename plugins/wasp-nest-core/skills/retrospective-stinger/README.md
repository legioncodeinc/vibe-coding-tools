...
The procedural arsenal for `retrospective-wasp-drone`, the Wasp Nest's retrospective facilitator and follow-through enforcer.
...
**Source:** `ai-tools/command-briefs/retrospective-wasp-drone-command-brief.md`
