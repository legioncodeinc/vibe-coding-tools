...
This folder accumulates dated retro output files authored by `retrospective-wasp-drone` during live facilitation cycles.
...
Reports are not created unless the user asks `retrospective-wasp-drone` to write the output to disk. By default, the Drone delivers the facilitation plan inline.
