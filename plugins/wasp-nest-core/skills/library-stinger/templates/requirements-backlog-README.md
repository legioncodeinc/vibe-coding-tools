...
ai_description: |
  ...
  library-wasp-drone creates new PRD folders on "write a PRD for X".
  ...
  qa/ subfolder (empty on creation; quality-wasp-drone writes QA reports here).
...
human_description: |
  ...
  - QA folder: qa/prd-007-feature-name-qa.md (created by quality-wasp-drone)
...
4. Create `qa/` subfolder (empty; `quality-wasp-drone` writes reports here).
