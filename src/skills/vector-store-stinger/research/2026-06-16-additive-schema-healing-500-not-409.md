...
Spine of `guides/deeplake-03-schema-healing.md`, `templates/migration-plan.md` (the additive heal plan), `examples/schema-heal-add-column.md`. Drives hard rules #2, #3, and #4.
