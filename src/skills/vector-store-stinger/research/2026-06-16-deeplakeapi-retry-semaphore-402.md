...
Spine of `guides/deeplake-05-querying-deeplakeapi.md`. Drives hard rules #6 (guard every fragment) and #8 (cite the DeeplakeApi path). Underpins the 500-retry reasoning in the schema-healing guide.
