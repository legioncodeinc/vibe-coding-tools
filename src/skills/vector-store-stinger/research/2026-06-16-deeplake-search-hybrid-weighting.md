...
Feeds `guides/deeplake-02-indexing.md` SShybrid and `templates/indexes-decision-tree.md` Step 3. The weights are a should-refactor lever, not a must-fix - a vector-only query where hybrid clearly wins is the finding.
