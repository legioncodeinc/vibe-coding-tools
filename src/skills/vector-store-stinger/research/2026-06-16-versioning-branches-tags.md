...
Spine of `guides/deeplake-04-versioning-branches.md`. Cross-referenced from `guides/deeplake-06-embeddings-jsonb-versioning.md` so dataset versioning and the per-row version-bump stay distinct.
