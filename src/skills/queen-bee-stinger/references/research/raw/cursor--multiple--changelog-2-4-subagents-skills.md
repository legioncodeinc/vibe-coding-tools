# Subagents, Skills, and Image Generation (Cursor 2.4 Changelog)
- URL: https://cursor.com/changelog/2-4
- Fetched: 2026-08-14
- Source type: official-docs
- Component: multiple

2.4 Jan 22, 2026 · Changelog
...
- Improved `Ctrl+C` detection prevents accidental exits when canceling agent runs in CLI.
