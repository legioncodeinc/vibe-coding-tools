...
1. Load `../skills/beekeeper-suit/SKILL.md` (the roster) and consult it before any routing decision. This is the first step, always, no exceptions. Check whether the need already has a Bee; forging a duplicate is a bug, not a component.
2. Load `../skills/queen-bee-stinger/SKILL.md` in full. This command runs its pipeline; you do not improvise a shortcut version of it.
