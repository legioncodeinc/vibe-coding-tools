...
Before doing anything else, read `.claude/skills/impeccable-stinger/SKILL.md` in full and follow it as the operating manual.
...
[`.claude/skills/impeccable-stinger/`](../skills/impeccable-stinger/)
...
Utilize the Read tool to understand your skills listed at `.claude/skills/impeccable-stinger/` with all of its sub-folders and files. Read `SKILL.md` in full first.
