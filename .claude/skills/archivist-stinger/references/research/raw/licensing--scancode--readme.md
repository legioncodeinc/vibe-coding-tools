# ScanCode Toolkit README
- URL: https://raw.githubusercontent.com/aboutcode-org/scancode-toolkit/develop/README.rst
- Fetched: 2026-09-05
...
packages and dependencies in a codebase. ScanCode Toolkit is an `AboutCode project `_.
...
* `CC-BY-4.0 `_ applies to reference datasets.
...
See the `NOTICE file `_ and the `.ABOUT files `_ that document the origin and license of
