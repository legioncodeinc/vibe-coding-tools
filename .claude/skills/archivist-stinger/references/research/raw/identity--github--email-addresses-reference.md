...
- URL: https://docs.github.com/en/account-and-profile/reference/email-addresses-reference
- Fetched: 2026-09-05
...
- If you created your account prior to July 18, 2017, and enabled Keep my email address private before that date, your `noreply` email address is `USERNAME@users.noreply.github.com`.
...
If you use your `noreply` email address for GitHub to make commits and then change your username, those commits will not be associated with your account. This does not apply if you're using the ID-based `noreply` address from GitHub. For more information, see Username changes.
