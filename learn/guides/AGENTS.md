...
Vibe Coding Tools calls its agents **Bees**. There are 82. Each domain Bee has exactly one matching skill, called a **Stinger**. The Bee supplies judgment and responsibility. The Stinger supplies the detailed procedure, examples, and reference material.
